...
class RegisterPostService {
    ...
    static func userlogin (params:[String: AnyObject] , completionHandler: @escaping (GRUser) -> Void) {
        ...
        let request = Alamofire.request( URL + "user/apply_referral", method: .post, parameters: params, encoding: JSONEncoding.default, headers: nil).responseJSON { response in
